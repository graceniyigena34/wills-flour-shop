...
export const T = {
  ...
  rw: {
    ...
    home: {
      ...
      storyP1: "Ubunga bw'Imyumbati bwa Will bwavutse ku gitekerezo kiroroshye: miryango ikwiye ubunga bakwizera. Dukorana hafi n'abahinzi b'imyumbati bo mu Afurika n'amakoperative, kugira ngo buri murwi wose ukorwe n'ubwitange, ubwiza, no gutunga neza.",
      storyP2: "Hejuru yo gutanga ubunga bw'imyumbati bw'inzego za hejuru, duhuriwe no gushyiraho amahirwe ku bagore mu buhinzi. Turifuza gukorana n'abahinzi bagore n'amakoperative ayobowe n'abagore, gutanga amasoko ya ngombwa y'imyumbati yabo no gufasha gukomeza imibereho mu midugudu yo mu cyaro.",
      storyP3: "Intego yacu ni gutanga ubunga buzima, bw'kamere, no bw'ubwiza bw'imyumbati mu mbaga no mu mabokisi y'ubunyange mu Afurika no hanze yayo, ndetse no gukomeza abahinzi bagore b'Abanyafurika binyuze mu bikorwa by'ubuhinzi birimo abantu bose.",
      readStory: "Soma inkuru yacu",
      featured: "Ibiri imbere", craftedTitle: "Yakozwe ku biko byose.", viewAll: "Reba ibicuruzwa byose →",
      prod1Title: "Ubunga Bwera", prod1Text: "Buninahaza, bwatsindwe neza kandi buteguye guteka.",
      prod2Title: "Ingurube y'Umuryango", prod2Text: "Ingungu za kraft za 2kg zisumba — ubunga bwera bw'imyumbati.",
      prod3Title: "Ingero Nta Mpera", prod3Text: "Kuva ku mugali kugeza ku patiseri, imigati no hanze.",
      whyEyebrow: "Impamvu yo gutoranya",
      whyTitle: "Impamvu esheshatu miryango ikunda", whyItalic: "kwizera", whyEnd: "twe.",
      feat1Title: "Ntagira Gluten", feat1Text: "Ntagira gluten ku kamere, iroroshye ku nda kandi iboneye ku buri ndyo.",
      feat2Title: "100% Kamere", feat2Text: "Ntagira ibiyongeweho, ntagira kwera — ubwiza bw'imizi y'imyumbati gusa.",
      feat3Title: "Ihoroshye", feat3Text: "Isoko nziza y'uburutini, umususuruko no sitarisho ivura.",
      ...
      feat6Title: "Yakozwe neza", feat6Text: "Buri gahanga rirasoza inzira yo gukora isukuye kandi ikomeye ku biribwa.",
      ...
      step2Title: "Kwihekenya", step2Text: "Imizi irihekenywa neza kugira ngo uburabyo bwera bwone bubone gusa.",
      step3Title: "Kuzamisha", step3Text: "Bizamishwa mu mazi asukuye kugira ngo havanwe ibintu bibi n'inzangano.",
      step4Title: "Gukama", step4Text: "Bimesha ku nzira zizimuye kugeza bikorora neza kandi biteguye.",
      step5Title: "Gutsinda", step5Text: "Gutsindwa hakoreshejwe amabuye ngo habone ubunga buninahaza abaguzi bacu bakunda.",
      step6Title: "Gupakira", step6Text: "Bifungirwa mu isabune zikomeye ku biribwa kugira ngo bikomeze kuva mu tsinda kugeza mu mbaga yawe.",
      voicesEyebrow: "Ijwi dukundaho", voicesTitle: "Ibyo abakiriya bacu bavuga.",
      test1Q: "Ubwinshi buratangaje — umugati wanjye ubura neza buri gihe.", test1A: "Aline, Kigali",
      test2Q: "Hanyuma ubunga ntagira gluten umuryango wanjye wongeye gukundana nta kuzigama.", test2A: "Joseph, Musanze",
      test3Q: "Twasimbuye ibaka ryacu ryose na Will's. Ubwiza ntabwo bushobora guhanganwa.", test3A: "Chef Marie, Nyamirambo",
